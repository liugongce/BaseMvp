 ...
 * tabPageIndicator.setDividerColorResource(R.color.line);// 设置分割线的颜色
 * tabPageIndicator.setDividerPadding(10);//设置
 * tabPageIndicator.setIndicatorColorResource(R.color.foot_choose);// 设置底部导航线的颜色
 * tabPageIndicator.setTextColorSelectedResource(R.color.foot_choose);// 设置tab标题选中的颜色
 * tabPageIndicator.setTextColorResource(R.color.text_black);// 设置tab标题未被选中的颜色
 * tabPageIndicator.setTextSize(14);// 设置字体大小
 * tabPageIndicator.setUnderlineColorResource(R.color.line);
