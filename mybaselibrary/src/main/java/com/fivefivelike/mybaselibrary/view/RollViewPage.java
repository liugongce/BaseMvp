...
public class RollViewPage implements OnPageChangeListener {
    ...
    /*
     new RollViewPage.BannerBuilder(getActivity())
                ...
                .setCirculation(true)
                .setShowDot(true)
                .setDotSelectorColorResouse(R.color.foot_choose)
                .setDotNormalColorResouse(R.color.advertist_blue)
                .setDotSizeResouse(R.dimen.text_trans_10px)
    ...
    private void addView(int count) {
        ...
        for (Object object : banList) {
            if (object instanceof View) {
                ...
                Glide.with(context).load(object.toString()).into(iv);
                list_image.add(iv);
            }
        }
